...
function fnShowMyWarehouseVisualizerDemo(){
	...
	if (!appWarehouses[warehouseIndex].layoutData){
		...
		d3.csv( "../static/data/" + warehouseName + "/layout.csv", fnParse ) //https://github.com/d3/d3-fetch#csv
		...
		function fnLoadWarehouseData(warehouseName, warehouseScene, layoutData){
			...
			d3.csv( "../static/data/" + warehouseName + "/inventory.csv", fnParse ) //https://github.com/d3/d3-fetch#csv
